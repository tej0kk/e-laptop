        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-5">Input your data to register to our laptop.</p>
                    ...
                    <form action="{{ url('/register') }}" method="POST">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password"
                                class="form-control @error('confirm_password') is-invalid @enderror form-control-xl"
